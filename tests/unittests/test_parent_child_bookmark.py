...
from tap_drip.streams.abstracts import ParentBaseStream
...
class TestSync(unittest.TestCase):
    @patch("tap_drip.streams.abstracts.metadata.to_map")
    ...
    @patch("tap_drip.streams.abstracts.ParentBaseStream.is_selected", return_value=True)
    @patch("tap_drip.streams.abstracts.ParentBaseStream.get_bookmark", return_value=100)
    ...
    @patch("tap_drip.streams.abstracts.IncrementalStream.get_bookmark", return_value = 100)
    ...
    @patch("tap_drip.streams.abstracts.BaseStream.is_selected", return_value=True)
    @patch("tap_drip.streams.abstracts.IncrementalStream.get_bookmark", side_effect = [100, 50, 75])
