...
from tap_drip.streams.abstracts import IncrementalStream
...
class TestSync(unittest.TestCase):
    ...
    @patch("tap_drip.streams.abstracts.get_bookmark", return_value=100)
    ...
    @patch("tap_drip.streams.abstracts.get_bookmark", return_value=300)
